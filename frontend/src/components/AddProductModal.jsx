...
import { DollarSignIcon, Package2Icon, ImageIcon, PlusCircleIcon } from 'lucide-react';
    ...
    return (
        <dialog id='add_product_modal' className='modal'>
            <div className='modal-box'>
                { /* CLOSE BUTTON */}
                <form method='dialog'>
                    <button className='btn btn-sm btm-circle btn-ghost absolute right-2 top-2'>X</button>
                </form>
